...
export default TodoApp;
 ...
 <sub>[<< Poprzedni](https://github.com/donatuss/Redux/blob/master/07-todoapps-toggling-todo/README.md)
  | [Następny >>](https://github.com/donatuss/Redux/blob/master/09-todoapp-extracting-presentional/README.md)
 </sub>